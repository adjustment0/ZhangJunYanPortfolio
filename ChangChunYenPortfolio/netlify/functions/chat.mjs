export default async (req, context) => {
  ...
  try {
    ...
    const systemPrompt = `
      ...
      - 影音技能：Adobe After Effects (國際證照), Premiere, Blender。
      - 作品亮點：Shadow Archer (Unity3D RPG), RUNIMON (Unity2D Sidescroller),Visual Portfolio (AE), Fire Dragon VFX, IMS 庫存管理系統 (WinForms)。
